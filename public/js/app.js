...
new Vue({
  ...
  methods: {
    addPerson: function addPerson(e) {
      e.preventDefault();
      this.data.push(Vue.util.extend({}, this.newItem));
    },
    removePerson: function removePerson(e) {
      e.preventDefault();
    ...
    onSubmit: function onSubmit() {
      axios.post('/people/store', this.data).then(function (response) {
...
Component.options.__file = "/Users/Makanaokeakua/Sites/challenge/resources/assets/js/components/Example.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-425ce62f", Component.options)
  } else {
    hotAPI.reload("data-v-425ce62f", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-425ce62f", module.exports)
  }
}
